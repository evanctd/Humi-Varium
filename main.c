...
void TIM2_IRQ(void){
	...
	int SR_Register = TIM2->SR;
	cpt++;

	printf("TIM2_IRQ cpt: %d s\r\n",cpt);

	if(SR_Register & TIM_SR_CC1IF){
		tenth = 1;
		printf("Registre cnt:%lu\r\n", TIM2->CNT);
